...
public class PixelleFrame extends JFrame {
    ...
    public PixelleFrame() throws PixelleTransformException {
        this(new PixelleTransformer(new PixelleImage[] { new PixelleImage() }, PixelleTransformer.getSampleTransform(), ImageType.RGB, new Point(400, 400))
                .transform(), false);
    }
                    ...
                    if ((inspector != null) && !inspector.isFrozen()) {
                        ...
                        if (!lastPoint.equals(p)) {
                            ...
                            if ((p.x >= 0) && (p.y >= 0) && (p.x < iWidth) && (p.y < iHeight)) {
                                ...
                                inspector.setInspectorColor(ImageType.fromImage(image.getSaveImage()), new Color(color[0], color[1], color[2]), color[3]);
                            }
                        }
                    }
                }
