...
public class PixelleExpressionDialog extends JDialog {
    ...
    private final Map<PixelleComponent, JLabel> rgbLHS = new EnumMap<PixelleComponent, JLabel>(PixelleComponent.class);
    {
        for (PixelleComponent comp : PixelleComponent.rgbValues()) {
            rgbLHS.put(comp,
                    new JLabel(PixelleBundle.getFormattedString(PixelleBundle.PIXEL_EQUALS, PixelleBundle.getString("formula." + comp.name().toLowerCase()))));
        }
    }
        ...
        private final void initListeners() {
            addButton.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent ae) {
                    ...
                    PixelleFrame pixFrame = (PixelleFrame) JOptionPane.showInputDialog(SourcePanel.this,
                            PixelleBundle.getString(PixelleBundle.PICK_SOURCE_LABEL), PixelleBundle.getString(PixelleBundle.TITLE),
                            JOptionPane.QUESTION_MESSAGE, null, frames.toArray(new JFrame[frames.size()]), null);
                    if (pixFrame != null) {
